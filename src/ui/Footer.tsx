    ...
    <footer className="bg-gradient-to-br from-neutral-900 to-neutral-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          {/* Project Info */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">The Project</h3>
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Taveta Sub-County, Taita Taveta County, Kenya</span>
              </li>
              <li className="flex items-start gap-2">
                <svg
                  className="w-5 h-5 mt-0.5 flex-shrink-0 text-primary-400"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/60 text-sm text-center md:text-left">
              © 2026 IFSL Project. All rights reserved.
            </p>
